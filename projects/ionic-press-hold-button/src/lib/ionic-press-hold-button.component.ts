...
@Component({
  selector: 'ionic-press-hold-button',
  standalone: true,
  imports: [IonicModule, CommonModule],
  templateUrl: './ionic-press-hold-button.component.html',
  styleUrls: ['./ionic-press-hold-button.component.scss'],
})
export class IonicPressHoldButtonComponent implements OnInit {
